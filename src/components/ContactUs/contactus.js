...
import contact_banner from "../../img/contact_banner.png";
...
function Gallery() {
  return (
    <div>
      ...
      <div class="wrapper">
        <div className="row">
          <img src={tel} alt="telephone" className="icon"></img><br></br>
          <a
            href="+3219996545"
        ...
        <div className="row">
          <img src={email} alt="email" className="icon"></img><br></br>
          ijfc@gmail.com
        </div>
        <div className="row">
          <img src={location} alt="location" className="icon"></img><br></br>
          ijfc location
        </div>
      </div>
